package me.wolf.wlastmanstanding.constants;
...
public class Constants {
    ...
    public static class Messages {
        public static final String ADMIN_HELP = Utils.colorize(
                "&7[-------&bLMS &cAdmin &bHelp&7-------]\n" +
                        "&b/lms createarena <arena> &7- Creates a new arena \n" +
                        "&b/lms deletearena <arena> &7- Deletes an arena\n" +
                        "&b/lms setworldspawn &7- Sets the world spawn \n" +
                        "&b/lms setlobby <arena> &7- Sets the lobby for the arena \n" +
                        "&b/lms setspawn <arena> &7- Sets a spawn point for the arena\n" +
                        "&b/lms spawnnpc &7- Spawns an auto-join NPC\n" +
                        "&b/lms forcestart <arena> &7- Force starts a game &c[Not Supported]\n" +
                        "&b/lms tp <arena> &7- Teleports you to the arena\n" +
                        "&7[-------&bLMS &cAdmin &bHelp-------]");
        ...
        public static final String HELP = Utils.colorize(
                "&7[------- &bLMS Help &7-------]\n" +
                        "&b/lms join <arena> &7- Join the arena\n" +
                        "&b/lms leave &7- Leaves the arena\n" +
                        "&b/lms help &7- Displays the help command\n" +
                        "&7[------- &bLMS Help &7-------]");
        ...
        public static final String KIT_SELECTED = Utils.colorize(
                "&aSuccessfully selected the kit {kit}");
